...
| Diagram | Description |
|---|---|
| [Class Diagram](docs/class_diagram.md) | Full class structure following MVT architecture and Strategy Pattern |
| [Sequence Diagram](docs/sequence_diagram.md) | End-to-end song generation flow from form submission to playback |
